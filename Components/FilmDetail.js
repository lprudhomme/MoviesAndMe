...
class FilmDetail extends React.Component {
  ...
  // Permet d'ajouter l'icone + de partage sur IOS (en haut à droite de la vue)
  static navigationOptions = ({ navigation }) => {
        ...
        if (params.film != undefined && Platform.OS === 'ios') {
          return {
              ...
              // ATTENTION : comme navigationOptions est static, _shareFilm ne PEUT pas être bindée même avec la notation pointée. Il faut donc le faire dans le constructor
  ...
  // Fonction pour faire passer la fonction _shareFilm et le film aux paramètres de la navigation (impossible de passer par le state vu que navigationOptions est static).
  ...
  // Dès que le film est chargé (et après maj le state), on met à jour les paramètres de la navigation (avec la fonction _updateNavigationParams) pour afficher le bouton de partage
  componentDidMount() {
